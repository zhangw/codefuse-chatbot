...
FSCHAT_OPENAI_API = {
    "host": DEFAULT_BIND_HOST,
    "port": 18888,  # model_config.llm_model_dict中模型配置的api_base_url需要与这里一致。
    "docker_port": 18888,  # model_config.llm_model_dict中模型配置的api_base_url需要与这里一致。
}
...
FSCHAT_MODEL_WORKERS = {
    ...
    'devops-7b': {'host': DEFAULT_BIND_HOST, 'port': 20002},
